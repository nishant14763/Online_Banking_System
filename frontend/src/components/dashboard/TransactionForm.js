                    ...
                    <Col className='col-md-6 col-sm-12'>
                        ...
                        <Form onSubmit={submitHandler}>
                            ...
                            <Form.Group className="mb-3 mt-3" controlId="formBasicEmail">
                                <Form.Label id="blk"> Beneficiary Name</Form.Label>
                                <Form.Control type="text" onChange={(event) => setBenificiaryName(event.target.value)} />
                            </Form.Group>

                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label id="blk"> Beneficiary Account Number</Form.Label>
                            ...
                            <Form.Group className="mb-3" controlId="ifsc">
                                <Form.Label id="blk"> IFSC Code</Form.Label>
                                <Form.Control type="text" onChange={(event) => setIfsc(event.target.value)} />
                            </Form.Group>

                            <Form.Group className="mb-3" controlId="amount">
                                <Form.Label id="blk">Amount</Form.Label>
